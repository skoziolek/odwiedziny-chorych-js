    ...
    function renderKalendarz() {
        ...
        for (let date = new Date(startDate); date <= endDate; date.setDate(date.getDate() + 1)) {
            ...
            row.innerHTML = `
                ...
                <td style="white-space: normal; word-wrap: break-word;">${swietoName}</td>
                <td>
                ...
                <td contenteditable="true">${data.uwagi || ''}</td>
                <td>
            ...
            // Sprawdź czy to najbliższy dyżur
            const dateOnly = new Date(date.getFullYear(), date.getMonth(), date.getDate());
            if (!nextDutyRow && dateOnly >= today && currentYear === today.getFullYear().toString()) {
                nextDutyRow = row;
            }
        }
